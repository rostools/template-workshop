...
# template-workshop: Template Workshop: An opinionated setup for making workshops as open educational resources
...
manage and develop several workshops in rostools, and this template is
...
used as an open educational resource (OVER). Use this template to
quickly get started with a new workshop with all the necessary files and
