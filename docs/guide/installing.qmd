...
- [Copier](https://copier.readthedocs.io/en/stable/): A template tool
  for making new workshops in a standardised and structured way.
...
install and use in any workshop created with this template:

- [Git](https://git-scm.com/): For version control and setting up Git to
  track the newly created workshop.
...
- [Quarto](https://quarto.org/): A scientific and technical publishing
  ...
  created with Quarto, and the workshop created from this template is
