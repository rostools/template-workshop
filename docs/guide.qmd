...
uvx copier copy --trust gh:{{< meta gh.org >}}/{{< gh.repo >}} .
```
...
[`copier.yml`](https://github.com/{{< meta gh.org >}}/{{< gh.repo >}}/blob/main/copier.yaml)
...
Next, install [`spaid`](https://github.com/{{< meta gh.org >}}/spaid) and
